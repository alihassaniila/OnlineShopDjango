    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.BigIntegerField(blank=True, null=True, unique=True, verbose_name='mobile number')),
                ('is_active', models.BooleanField(default=True, verbose_name='active')),
                ('is_staff', models.BooleanField(default=False, help_text='the user can log into this admin site.', verbose_name='staff status')),
